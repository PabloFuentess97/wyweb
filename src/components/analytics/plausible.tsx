 ...
 * Self-hosted en `analytics.wyweb.es` — solo se carga si las dos env vars
 * están configuradas. En `development` no se carga para evitar contaminar
 * métricas reales.
 *
 * Variables esperadas:
 *   NEXT_PUBLIC_PLAUSIBLE_DOMAIN   → dominio que Plausible registra (wyweb.es)
 *   NEXT_PUBLIC_PLAUSIBLE_HOST     → URL del Plausible self-hosted
 *                                    (default: https://analytics.wyweb.es)
 */
